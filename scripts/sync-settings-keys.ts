// Regenerate src/core/settings-keys.ts SCHEMA_KEYS from the official Claude Code
...
import { SETTINGS_SCHEMA_URL } from '../src/core/config.ts';

/** Absolute path to the module this script keeps in sync. */
const TARGET = fileURLToPath(new URL('../src/core/settings-keys.ts', import.meta.url));
...
export function renderSettingsKeysFile(schemaKeys: string[], appOnlyKeys: string[]): string {
  ...
  const header = [
    ...
    ' * Regenerated by scripts/sync-settings-keys.ts (run daily by the',
