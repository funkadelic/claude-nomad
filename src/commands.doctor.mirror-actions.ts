 ...
 * `disableActions` would run). All gh primitives carry the shared
 * `GH_TIMEOUT_MS` internally, so the remote probe is timeout-bounded with no
 * extra wiring here. No new doctor section; no opt-out flag.
 *
