...
inside a symlinked directory already removes it on macOS or Linux. The removal is left uncommitted (it publishes on your next push,
through the same secret scan as everything else) and the repo copy is snapshotted to the backup dir
