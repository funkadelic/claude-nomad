...
previews. It covers the mirror step only: fix the permissions before re-running, because a later
step in the same pull reads that file too. A file you delete from inside one of these directories
